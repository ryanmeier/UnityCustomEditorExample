...
public class GameBoardEditor : Editor
{
    ...
    private GameBoardTile selectedTile = GameBoardTile.EMPTY;
    ...
    public override void OnInspectorGUI()
    {
        ...
        boardTarget.playerObject = EditorGUILayout.ObjectField("Player", boardTarget.playerObject, typeof(GameObject)) as GameObject;
